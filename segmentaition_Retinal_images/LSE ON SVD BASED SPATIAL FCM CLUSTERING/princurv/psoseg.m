function [Iout,intensity,fitness,time]=psoseg(I,level,method)
tic;
% psoseg - MatLab function for Multiple Image Segmentation using PSO
% (Particle Swarm Optimization), DPSO (Darwinian PSO) and exhaustive 
% methods based on the image histogram shape. 
...
if strcmpi(method,'dpso') %DPSO method
    ...
    vmin=-1.2;          % Velocidade Máxima por iteração
    vmax=1.2;           % Velocidade Mínima por iteração
